# 更新记录 
* pg.20240805-1802.zip 【今日阿里,UC,115,夸克使用本jar不限速，阿里原画不需要svip也不用三方权益包，不需要115账号秒传也不需要115会员，115的分享内容无需付费即可欣赏，UC原画不需要会员，夸克原画非会员3G以内的视频随意看，88VIP20G以内的视频随便看】
1.所有分享csp列表页增加文件夹标识。
...
6.优化多线加载逻辑，提高起播速度。阿里比较小的文件有可能播放速度不如大文件，这个没办法是阿里的限制，尽量找高画质的看吧。
