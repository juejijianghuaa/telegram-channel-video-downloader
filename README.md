# 更新记录 
* pg.20250421-0910.zip 对不起，我是顶级视听控，阿里不限速网盘资源全秒播
...
今日更新内容：(更多内容阅读zip内的README.txt)
1.使用GO实现了一个简单高效的投屏接收器，可以接收某视频的投屏指令并将其中的AV3A音轨自动转码EAC3，投屏接收器名称为“PandaGO投屏[播放器IP]"。这是世界上唯一一个可以在非华为设备上简单流畅欣赏AV3A的5.1声道节目并直通功放的方案，该方案结合了各种黑科技，理论上如果是某视频的VIP用户是可以投屏4KHDR+AV3A频道到本接收器的，这样就可以用高端电视+影视EXO解码器+功放解码真正享受极致体验。
