...
* tgsearch.docker.zip tgsearch的docker版，x86_64平台运行，解压后使用sh rundocker.sh运行，会自动导入image。运行前需要手工修改docker-compose.yml文件，把相关的id放入，主要是session.
