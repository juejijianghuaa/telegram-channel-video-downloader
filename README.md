# 更新记录 
* pg.20240627-0933.zip 巨量修复和优化代理标签系统，现在代理标签系统可以非常稳定的工作了，修复绝大部分不正经csp。之前因为代理标签映射的bug会导致csp频繁出现丢失指定代理的问题。现在已经彻底修复之。有缘人必须升级到这个版本才能享受完全畅通的观影环境。各位施主也可以放心订阅了，不会再出现订阅后用不上代理的问题。
