# 更新记录 
* pg.20240617-1338.zip csp_Youtube优化硬件能力探测，只有播放设备支持HEVC(H265)时才会把VP9.2强制转成H265。
* pg.20240617-1254.zip csp_Youtube支持VP9.2的HDR，显示为H265，实测发现VP9.2比VP9和AV1都小好多，同时能提供真正的HDR能力，所以应该VP9.2是最佳观影格式。同时jar会自动检测硬件HDR支持能力，如果硬件不支持HDR会自动隐去HDR视轨。
